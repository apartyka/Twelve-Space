...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        /**
         * ## `concat`
         * This section has been commented out because of `uglify` does `concat`
         * But, still available if you need it:
            ```
                concat: {
                    dist: {}
                },
        ...
        htmlmin: {
            ...
            insider: {
                ...
                files: [{
                    ...
                    cwd: "../documentation",
                    src: "*.html",
                    dest: "../documentation/insider-docs"
                }]
            }
        },
        copy: {
        ...
        "regex-replace": {
            prod: {
                src: "../documentation/insider-docs/*.html",
                actions: regx
            }
        }
